...
// found in bytecodes.cpp in the hotspot
namespace splinter::engine::bytecode {
    std::string_view bytecodeTable::name(std::uint8_t opcode) noexcept {
        switch (opcode) {
            ...
            case 0xcb: return "fast_agetfield";
            case 0xcc: return "fast_bgetfield";
            case 0xcd: return "fast_cgetfield";
            case 0xce: return "fast_dgetfield";
            case 0xcf: return "fast_fgetfield";
            case 0xd0: return "fast_igetfield";
            case 0xd1: return "fast_lgetfield";
            case 0xd2: return "fast_sgetfield";
            case 0xd3: return "fast_aputfield";
            case 0xd4: return "fast_bputfield";
            case 0xd5: return "fast_zputfield";
            case 0xd6: return "fast_cputfield";
            case 0xd7: return "fast_dputfield";
            case 0xd8: return "fast_fputfield";
            case 0xd9: return "fast_iputfield";
            case 0xda: return "fast_lputfield";
            case 0xdb: return "fast_sputfield";
            case 0xdc: return "fast_aload_0";
            case 0xdd: return "fast_iaccess_0";
            case 0xde: return "fast_aaccess_0";
            case 0xdf: return "fast_faccess_0";
            case 0xe0: return "fast_iload";
            case 0xe1: return "fast_iload2";
            case 0xe2: return "fast_icaload";
            case 0xe3: return "fast_invokevfinal";
            case 0xe4: return "fast_linearswitch";
            case 0xe5: return "fast_binaryswitch";
            case 0xe6: return "fast_aldc";
            case 0xe7: return "fast_aldc_w";
            case 0xe8: return "return_register_finalizer";
            case 0xe9: return "invokehandle";
            case 0xea: return "nofast_getfield";
            case 0xeb: return "nofast_putfield";
            case 0xec: return "nofast_aload_0";
            case 0xed: return "nofast_iload";
            case 0xee: return "_shouldnotreachhere";
